...
\newcommand{\thingspeaklink}{\todoanswer{Insert public ThingSpeak channel link / ID}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.86\linewidth]{report_assets/thingspeak_field1_updates.png}
\caption{ThingSpeak field1 update sequence generated from the selected outgoing costs.}
\end{figure}

\textbf{Public ThingSpeak channel:} \thingspeaklink
